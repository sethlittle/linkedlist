...
public class LinkedListPlayground {
	...
	public static void printList(LinkedListImpl L) {
		// note that this is a good example of how to iterate through your
		// linked list
		// since we know how many elements are in the list we can use a for loop
		// and not worry about checking the next field to see if we hit the end
		// sentinel
		Node curr = L.sentinel.next; // the first data node in the list is the
										// one after sentinel.
